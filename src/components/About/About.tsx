...
const About = () => {
  return (
    <section id="About_me" className="py-20 px-5 bg-gray-950">
        <div className="md:max-w-3xl mx-auto ">
            ...
            <div className="space-y-5 tracking-wide font-light md:text-justify text-sm md:text-base">
                ...
                scalable web applications. Since then, I’ve been working with frameworks like Next.js, React, Tailwind and Django to build 
